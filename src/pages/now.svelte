<script>
	...
	let img = "https://timoanttila.com/images/timoanttila.jpg"
	metatags.title = "Timo Anttila | Now Profile"
	metatags.description = "Now page is a place to tell where my focus is right now in my professional and personal life."
	metatags.image = img
	metatags.url = "https://timoanttila.com/now"
	metatags.canonical = "https://timoanttila.com/now"
...
<div id="now" class="container">
	<div id="profilePic">
		<picture>
			...
			<img src="/images/timoanttila.jpg" alt="Timo Anttila | Full Stack Developer, photographer and sea adventurer" width="300" height="300">
		</picture>
	</div>
	<div class="content">
		<h1>Timo Anttila</h1>
		<p><em>"Living, learning, &amp; leveling up one day at a time."</em></p>
		<h2>Location:</h2>
		<p>Eurajoki, Finland</p>
		...
		<ul>
			...
			<li>PHP, JavaScript, Svelte, JQuery</li>
		</ul>
		<h2>Contact:</h2>
